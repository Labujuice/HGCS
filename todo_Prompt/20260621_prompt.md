...
### TODO
- [ ] 修復 Plan 視圖 Waypoint 模式雙擊無法新增航點的 Bug (解決 Map.tsx 中的 React 閉包過期問題)
- [ ] 修復 MAVLink 任務上傳被飛控拒絕的 Bug (兼容處理 MISSION_REQUEST 與 MISSION_REQUEST_INT，避免經緯度解碼出 1200 萬米外無效座標)
- [ ] 優化任務首點 TAKEOFF 拼接邏輯，確保上傳至 PX4 的第一個任務項目必定為 TAKEOFF 指令，順利通過 navigator 檢查
